...
const ExpertiseElem = hover => {
  console.log(hover)
  return (
    <div className="">
      <div className="flex">
        <div className="w-[20%] flex items-center justify-center">
          <svg viewBox="0 0 34 32" fill={hover ? '#61DBFB' : 'currentColor'} height="4em" width="4em">
            <path
              fill={hover ? '#61DBFB' : 'currentColor'}
      ...
      <div className="flex flex-col text-slate-500 text-sm font-body">
        ...
        <div className="flex">
          ...
          <div className="w-[80%] text-left text-white">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam expedita tempore eius laborum ut animi
              excepturi non quae.
            </p>
          </div>
        </div>
